    ...
    with open('../../RemoteController/set.txt', 'w') as file:
        ...
        for x_val, y_val in zip(x_geo, y_geo):
            ...
            if xbuf != x_val or ybuf != y_val:
                file.write(f"{np.rad2deg(x_val)} {np.rad2deg(y_val)}\n")
                xbuf = x_val
                ybuf = y_val
