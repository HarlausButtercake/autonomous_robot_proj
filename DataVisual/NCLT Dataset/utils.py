...
def plot_position_comparison_2D(x1: list, y1: list, x2: list, y2: list, est_type: str, label2: str,
...
def save_results(x_est: np.ndarray, P_est: np.ndarray, x_true_arr: np.ndarray, y_true_arr: np.ndarray,
                 theta_true_arr: np.ndarray, t: np.ndarray, dataset_date: str):
    # Save to files
...
def plot_states(x_est: np.ndarray, P_est: np.ndarray, x_true_arr: np.ndarray, y_true_arr: np.ndarray,
                theta_true_arr: np.ndarray, t: np.ndarray):
