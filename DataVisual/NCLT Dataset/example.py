...
TRUNCATION_END = 1200  # Ground Truth has 500000 data points, filter for testing. Set to -1 for all data
...
USE_WHEEL_FOR_CORRECTION = False  # Correct Prediction with Wheel velocity measurement
