...
# Coi dữ liệu từ GPS là chính xác 
# Hàm tính toán sai số (Tính khoảng cách từ 1 điểm đến đường thẳng nối bởi 2 điểm)
...
y_gps = []
y_recorded = []
length = 5000 # change it to 10000 for better result but it'll take more time
error =[]
...
# Plot (x, y)
plt.plot(x_recorded, y_recorded, color='blue',label='filtered')
